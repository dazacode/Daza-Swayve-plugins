...
enum SoundCloudIdKind {
  ...
  /// A station generated by the related-track recommender.
  radio,
}
...
abstract final class SoundCloudIds {
  ...
  static final RegExp _shape = RegExp(r'^([tpur])(\d+)$');
  ...
  /// A station seeded by the track [numericId].
  static SwayveMediaId radio(int numericId) =>
      mediaId(SoundCloudIdKind.radio, numericId);
}
